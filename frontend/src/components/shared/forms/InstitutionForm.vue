    ...
    <div class="card-body p-4">
      ...
      <form @submit.prevent="$emit('submit')">
        ...
        <div class="mb-4">
          ...
          <div class="row g-3">
            <div class="col-md-8">
              <BaseInput v-model="modelValue.name" label="Institution Name" type="text" placeholder="e.g., National University" :required="true" />
            </div>
            <div class="col-md-4">
              <BaseInput v-model="modelValue.short_name" label="Short Name" type="text" placeholder="e.g., NUST" />
            </div>
            <div class="col-md-4">
              <BaseInput v-model="modelValue.code" label="Institution Code" type="text" placeholder="e.g., NUST-ISB" :required="true" />
            </div>
            <div class="col-md-4">
              <BaseInput v-model.number="modelValue.established_year" label="Established Year" type="number" placeholder="e.g., 1991" />
            </div>
            <div class="col-md-4">
              <BaseInput v-model="modelValue.website" label="Website" type="url" placeholder="https://www.example.edu.pk" />
            </div>
          </div>
        </div>
        ...
        <div class="mb-4">
          ...
          <div class="row g-3">
            <div class="col-md-6">
              <BaseInput v-model="modelValue.email" label="Email" type="email" placeholder="info@institution.edu.pk" />
            </div>
            <div class="col-md-6">
              <BaseInput v-model="modelValue.phone" label="Phone" type="tel" placeholder="+92 51 1234567" />
            </div>
          </div>
        </div>
