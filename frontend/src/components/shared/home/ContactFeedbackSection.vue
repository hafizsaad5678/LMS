  ...
  <section id="contact" class="py-5 bg-light border-top">
    <div class="container">
      ...
      <div class="row g-5">
            ...
            <div class="card-body p-5">
              ...
              <form @submit.prevent="submitContact">
                <div class="mb-3">
                  ...
                  <input type="email" class="form-control border-light-subtle-subtle px-3 py-2" v-model="contact.email" required placeholder="name@company.com">
                </div>
                <div class="mb-3">
                  <label class="form-label fw-medium">Company Name</label>
                  <input type="text" class="form-control border-light-subtle-subtle px-3 py-2" v-model="contact.company" required placeholder="SaaS Inc.">
                </div>
                <div class="mb-4">
                  <label class="form-label fw-medium">How can we help?</label>
                  <textarea class="form-control border-light-subtle-subtle px-3 py-2" rows="4" v-model="contact.message" required placeholder="Tell us about your scale and use-case..."></textarea>
                </div>
                <button type="submit" class="btn btn-primary w-100 fw-bold py-2 rounded-pill shadow-sm" :disabled="isSubmittingContact">
        ...
        <div class="col-lg-6">
          <div class="card border border-light-subtle shadow-sm rounded-4 h-100 bg-light text-dark bg-gradient">
            <div class="card-body p-5 d-flex flex-column justify-content-center">
              <div class="mb-5 text-center">
                <i class="bi bi-rocket-takeoff-fill display-3 text-primary mb-3"></i>
              ...
              <form @submit.prevent="submitFeedback">
                <div class="mb-3 position-relative">
                  ...
                  <button type="submit" class="btn btn-primary position-absolute top-50 end-0 translate-middle-y rounded-circle me-1" style="height: 38px; width: 38px; padding: 0;" :disabled="isSubmittingFeedback">
                    <i class="bi bi-send-fill text-dark" v-if="!isSubmittingFeedback"></i>
                    <span v-else class="spinner-grow spinner-grow-sm text-dark"></span>
                  </button>
                </div>
