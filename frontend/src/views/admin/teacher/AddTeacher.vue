            ...
            <form @submit.prevent="handleSubmit">
              ...
              <div class="mb-4">
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      <label for="gender-select" class="form-label">Gender <span class="text-danger">*</span></label>
                      <select id="gender-select" v-model="form.gender" class="form-select" required>
                ...
                <div class="row g-3">
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <select id="department-select" v-model="form.department" class="form-select" required>
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      <label for="designation-select" class="form-label">Designation</label>
                      <select id="designation-select" v-model="form.designation" class="form-select">
              ...
              <div class="mb-4">
                ...
                <div class="row">
                  <div class="col-12">
                    <label class="form-label">Assign Subjects to Teach</label>
                    ...
                    <small class="text-muted mt-2 d-block">
                      Selected: {{ form.teaching_subjects.length }} subject(s)
                    </small>
                  </div>
                </div>
              </div>
              ...
              <div class="mb-4">
                ...
                <div class="row g-3">
                  <div class="col-12">
                    <div class="mb-3">
                      <label for="address-textarea" class="form-label">Address</label>
                      <textarea 
                        id="address-textarea"
              ...
              <div class="d-flex gap-3 justify-content-end pt-3 border-top">
                ...
                <button type="submit" class="btn btn-admin-primary px-4" :disabled="submitting">
                  <span v-if="submitting">
                    <span class="spinner-border spinner-border-sm me-2"></span>Adding Teacher...
                  </span>
                  <span v-else><i class="bi bi-check-circle me-2"></i>Add Teacher</span>
                </button>
              </div>
            </form>
          </div>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    const msg = error.response?.data?.detail || error.response?.data?.cnic?.[0] || error.response?.data?.email?.[0] || 'Failed to add teacher.'
